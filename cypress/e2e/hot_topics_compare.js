describe("Analytics Filters", function () {
  ...
  beforeEach("Go to Data Page", () => {
    cy.visit("/data");
    // Opens Compare Sidebar on Analytics
    cy.openCompare();
  });
  ...
  it("Add Compare Filters", () => {
    ...
    cy.get(
      ...
      .should("contain", "August/2022 (495)")
      .and("contain", "September/2022 (256)")
      .and("be.visible");
    ...
    //Clear Filters
    cy.get(
      ".SidebarWrapper--compare > .SidebarWrapper-container > :nth-child(1) > .clearfix > .btn"
    )
      .contains("Clear Compare")
      .click();
